export const teamMembers = [
  {
    ...
    bio: "Michele Cucchierato is the Co-Founder, Chairman, and CEO of Planet Sayari Group, a pioneering force in the evolution of crypto banking and digital finance.",
    description: "Michele Cucchierato is the Co-Founder, Chairman, and CEO of Planet Sayari Group, a pioneering force in the evolution of crypto banking and digital finance. With a wealth of experience in the financial sector and deep expertise in blockchain technology, Michele bridges the worlds of traditional and decentralized finance with clarity, vision, and purpose. Throughout his career, Michele has demonstrated a strong commitment to innovation, strategic leadership, and sustainable growth. His forward-thinking approach has been instrumental in shaping Planet Sayari's mission to deliver secure, user-centric, and future-ready financial solutions on a global scale.",
    expertise: ["Financial Strategy", "Blockchain Technology", "Strategic Leadership", "Digital Finance"],
    social: {
  ...
  },
  {
    ...
    bio: "Dr. Shermaine Nicholas is the founder of Planet Sayari, a company at the forefront of revolutionizing crypto banking.",
    description: "Dr. Shermaine Nicholas is the founder of Planet Sayari, a company at the forefront of revolutionizing crypto banking. With over 20 years of experience in business and a PhD in Christian Counseling, and currently pursuing a JD degree, Dr. Nicholas brings a rare blend of academic depth, industry insight, and visionary leadership. A lifelong advocate for innovation, Dr. Nicholas is deeply passionate about blockchain technology and its potential to transform the global financial system. Through Planet Sayari, she is leading efforts to bridge the gap between traditional banking and decentralized finance—empowering users with secure, accessible, and future-ready financial solutions.",
    expertise: ["Business Strategy", "Social Responsibility", "Blockchain Innovation", "Leadership"],
    social: {
      twitter: "https://twitter.com",
      linkedin: "https://linkedin.com",
      facebook: "https://facebook.com",
  ...
  },
  {
    ...
    bio: "Brad Moore is a seasoned finance professional with over 20 years of experience in the financial services industry.",
    description: "Brad Moore is a seasoned finance professional with over 20 years of experience in the financial services industry. He is a Co-Founder of Planet Sayari, and serves as the Co-CEO and Vice Chairman of the company. Holding a degree in business, and currently pursuing his MBA, Mr. Moore has built a career marked by deep expertise in financial strategy, risk management, and emerging financial technologies. Whether consulting on blockchain integration, financial strategy, or emerging market trends, Mr. Moore is committed to delivering smart, sustainable solutions that move businesses forward. Known for a strategic mindset and a forward-thinking approach, Mr. Moore continues to drive impactful solutions at the intersection of finance and technology.",
    expertise: ["Financial Services", "Risk Management", "Blockchain Integration", "Strategic Planning"],
    social: {
      twitter: "https://twitter.com",
      linkedin: "https://linkedin.com",
      facebook: "https://facebook.com",
  ...
  },
  {
    ...
    bio: "Zaahir Ibrahim Pooloo is a key member of the Board of Directors at Planet Sayari Group.",
    description: "Zaahir Ibrahim Pooloo is a key member of the Board of Directors at Planet Sayari Group. With a robust background in economics and extensive experience in the banking sector, Zaahir brings valuable insights and strategic direction to the company. His expertise in both traditional and innovative financial solutions plays a pivotal role in guiding the group's growth and success. Zaahir's dedication and expertise make him an invaluable asset to Planet Sayari Group. His contributions to the board help steer the company towards achieving its mission of providing secure, transparent, and efficient financial services.",
    expertise: ["Financial Management", "Banking", "Economics", "Strategic Planning"],
    social: {
      twitter: "https://twitter.com",
      linkedin: "https://linkedin.com",
      facebook: "https://facebook.com",
